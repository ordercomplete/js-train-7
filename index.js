...
function createSymbolForKey(key) {
  ...
  // Symbol.for() шукає символ в глобальному реєстрі символів. Якщо символ з таким ключем вже існує, він повертає його, в іншому випадку створює новий символ з даним ключем та додає його в реєстр
...
let myObject = {
  ...
  [Symbol.iterator]() {
    ...
    return {
      next() {
        if (currentIndex < myObject.category.length) {
          let value = myObject.category[currentIndex].name;
          currentIndex++;
